...
| Artifact validation | Bounded existing/generated sources, JSON, XML, YAML, HCL, Dockerfile, Compose, and Kubernetes validation implemented internally; CLI integration pending |
| IATROS Doctor | Production, reliability, performance, security, deployment, and cost audit coverage with unified findings implemented internally; CLI integration pending |
